...
{
    Timer timer;
    int rc = qiot_wifi_config_start(WIFI_CONFIG_TYPE_BT_COMBO, NULL, _wifi_config_result_cb);
    countdown(&timer, 500);
...
void wifi_config_sample_main(void *pvParameters)
{
    int rc;
...
void inter_llsync_combo(void *pvParameters)
{
